...
```
    ...
    FMU:            IO
        InstanceName:   IO
        Address:        Ptr{Nothing} @0x000001d87008e9a0
        State:          0
        Logging:        true
        FMU time:       -Inf
        FMU states:     nothing
...
```
    ...
    (18.98752533111937, true, 96, "Random number 63.89015416868523!")
...
```
    ...
    Callback-Evaluations:
    	...
    	Steps completed: 0
    Values [2]:
    	0.0	(18.98752533111937, 1.0, 96.0)
    	1.0	(18.98752533111937, 1.0, 96.0)
    Events [0]:
...
```
    ...
    (44.54614695829658, false, 22, "Random number 64.91815971898718!")
...
```
    ...
    Callback-Evaluations:
    	...
    	Steps completed: 0
    Values [2]:
    	0.0	(44.54614695829658, 0.0, 22.0)
    	1.0	(44.54614695829658, 0.0, 22.0)
    Events [0]:
